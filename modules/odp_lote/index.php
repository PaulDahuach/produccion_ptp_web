...
<div class="card mb-3">
  <div class="card-body py-2">
    <div class="row g-2 align-items-end">
      ...
      <div class="col-md-3">
        <label class="form-label mb-1 small">Sector</label>
        <select id="fEtapa" class="form-select form-select-sm"><option value="">— Todos —</option></select>
      </div>
      <div class="col-md-2">
  ...
  <div class="card-body">
    ...
    <table id="tbl" class="table table-sm table-striped table-hover w-100">
      <thead><tr>
        ...
        <th>Proceso</th><th>O. Corte</th><th>C. Artículo</th><th>PTP N°</th>
        <th class="text-end">Cantidad</th><th class="text-end">Días Rec</th>
        <th class="text-end">Días Def</th><th class="text-end">Orden</th><th class="text-end">Lote</th>
      </tr></thead>
      <tbody></tbody>
    </table>
  </div>
